...
# # 读取基因型文件
# if geno in os.listdir():
#     genotype = pd.read_pickle(geno)
# else:
#     os.system('/media/mang/diskB/./plink --bfile {} --recode A --out {} --chr-set 50 '.format(geno, geno))
#     genotype = change_raw('{}.raw'.format(geno))
#     genotype.to_pickle(geno)
